...
class User
{
    ...
    private $db_host = "localhost"; // Доступ к хосту, обычно - localhost
    private $db_name = "registr"; // Имя базы данных
    private $db_user = "root"; // Логин от базы данных
    private $db_pass = "root"; // Пароль от базы данных
